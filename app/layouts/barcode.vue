...
<template>
  ...
  <div class="container mx-auto flex gap-x-4 py-24">
    <div class="space-y-4">
      <UPageCard v-if="!stationStore.showStationSelection && stationStore.selectedStation" :title="stationStore.selectedStation.name" variant="subtle">
        <template #description>
          <p>{{ stationStore.selectedStation.description || 'İstasyon açıklaması' }}</p>
        </template>
      </UPageCard>
